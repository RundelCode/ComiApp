...
import 'schema/ofertas_especiales_record.dart';
...
export 'schema/ofertas_especiales_record.dart';
...
/// Functions to query OfertasEspecialesRecords (as a Stream and as a Future).
Future<int> queryOfertasEspecialesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      OfertasEspecialesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<OfertasEspecialesRecord>> queryOfertasEspecialesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      OfertasEspecialesRecord.collection,
      OfertasEspecialesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<OfertasEspecialesRecord>> queryOfertasEspecialesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<int> queryProductoRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      ProductoRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
