...
import '/components/empty_products/empty_products_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<NegocioRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<NegocioRecord> buscarNegocioRecordList = snapshot.data!;
                          ...
                          builder: (context) {
                            ...
                            return Column(
                              ...
                              children: List.generate(busqueda.length,
                                  (busquedaIndex) {
                                final busquedaItem = busqueda[busquedaIndex];
                                return Row(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    Expanded(
